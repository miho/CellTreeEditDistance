...
public class ClusterPair implements Comparable<ClusterPair> {
	...
	private Float linkageDistance;

    public ClusterPair(){
    }

	public ClusterPair(Cluster left, Cluster right, Float distance) {
        lCluster=left;
        rCluster=right;
  ...
  public Cluster getOtherCluster(Cluster c) {
	...
	public Float getLinkageDistance() {
        return linkageDistance;
    }

	public void setLinkageDistance(Float distance) {
    ...
    public Cluster agglomerate(String name) {
        ...
        Float lWeight = lCluster.getWeightValue();
        Float rWeight = rCluster.getWeightValue();
		float weight = lWeight + rWeight;
