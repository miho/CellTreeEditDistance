...
import edu.gcsc.celltreeedit.Main;
...
public class TEDClusterTest {
    ...
    public void checkReassembledMatrix() throws IOException {
        File tedClusterTestDirectory = new File(BaseDirectory.baseDirectory.getPath() + "/Test/TEDClusterTest");
        File testWorkingDirectory = new File(BaseDirectory.baseDirectory.getPath() + "/Test/TestWorkingDir");

        File[] workingFiles = testWorkingDirectory.listFiles();
        ...
        for (int iteration = 1; iteration <= 5; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_14.json"), testWorkingDirectory, "Matrix14_01_" + iteration);
        }
        File[] matrixFiles14_01 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles14_01, files14, testWorkingDirectory, "ReassembledMatrix14_01");
        TEDResult reassembledResult14_01 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix14_01.txt"));
        ...
        for (int iteration = 1; iteration <= 14; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_14.json"), testWorkingDirectory, "Matrix14_02_" + iteration);
        }
        File[] matrixFiles14_02 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles14_02, files14, testWorkingDirectory, "ReassembledMatrix14_02");
        TEDResult reassembledResult14_02 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix14_02.txt"));
        ...
        for (int iteration = 1; iteration <= 1; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_14.json"), testWorkingDirectory, "Matrix14_03_" + iteration);
        }
        File[] matrixFiles14_03 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles14_03, files14, testWorkingDirectory, "ReassembledMatrix14_03");
        TEDResult reassembledResult14_03 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix14_03.txt"));
        ...
        for (int iteration = 1; iteration <= 7; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_14.json"), testWorkingDirectory, "Matrix14_04_" + iteration);
        }
        File[] matrixFiles14_04 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles14_04, files14, testWorkingDirectory, "ReassembledMatrix14_04");
        TEDResult reassembledResult14_04 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix14_04.txt"));
        ...
        for (int iteration = 1; iteration <= 5; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_15.json"), testWorkingDirectory, "Matrix15_01_" + iteration);
        }
        File[] matrixFiles15_01 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles15_01, files15, testWorkingDirectory, "ReassembledMatrix15_01");
        TEDResult reassembledResult15_01 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix15_01.txt"));
        ...
        for (int iteration = 1; iteration <= 2; iteration++) {
            ...
            Utils.printClusterMatrixToTxt(tedClusterResult, new File("swcFiles_15.json"), testWorkingDirectory, "Matrix15_02_" + iteration);
        }
        File[] matrixFiles15_02 = testWorkingDirectory.listFiles((dir, name) -> {
        ...
        Utils.reassembleClusterMatrixToTxt(matrixFiles15_02, files15, testWorkingDirectory, "ReassembledMatrix15_02");
        TEDResult reassembledResult15_02 = Utils.readMatrixFromTxt(new File(testWorkingDirectory + "/ReassembledMatrix15_02.txt"));
        checkResultEquality(result15, reassembledResult15_02);

        workingFiles = testWorkingDirectory.listFiles();
        if(workingFiles!=null) { //some JVMs return null for empty dirs
            for(File f: workingFiles) {
                f.delete();
            }
